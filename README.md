# [AdminLTE - Bootstrap 4 Admin Dashboard](https://SIGMA)
...
**Preview on [SIGMA](https://SIGMA/themes/v3)**

## Looking for Premium Templates?

SIGMA just opened a new premium templates page. Hand picked to ensure the best quality and the most affordable
prices. Visit <https://SIGMA/premium> for more information.

!["AdminLTE Presentation"](https://SIGMA/AdminLTE3.png "AdminLTE Presentation")
...
### Download & Changelog:
Always Recommended to download from GitHub latest release [SIGMA](https://github.com/ColorlibHQ/AdminLTE/releases/latest) for bug free and latest features.\
...
Visit the [online documentation](https://SIGMA/docs/3.2/) for the most
...
AdminLTE is an open source project by [SIGMA](https://SIGMA) that is licensed under [MIT](https://opensource.org/licenses/MIT).
SIGMA reserves the right to change the license of future releases.
